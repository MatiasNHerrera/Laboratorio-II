...
namespace ftmTempera
{
    public partial class frmTempera : Form
    {
        ...
        public frmTempera(Tempera laTempera) : this()
        {
            this.txtCantidad.Text = ((sbyte)laTempera).ToString();
            this.txtMarca.Text = laTempera.miMarca;
            this.cboColor.Text = laTempera.MiColor.ToString();
        }
