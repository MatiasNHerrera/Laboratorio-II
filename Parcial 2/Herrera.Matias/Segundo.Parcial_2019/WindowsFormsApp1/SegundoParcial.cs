...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Herrera Matias");
        }
        ...
        private void btnPunto5_Click(object sender, EventArgs e)
        {
            ...
            this.c_bananas.eventoPrecio += new CajonLleno(man.Manejador);
        ...
        private static string ObtenerListadoFrutas()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    retorno += reader["nombre"].ToString() + reader["peso"].ToString() + reader["precio"].ToString() + "\n";
                }
            }
            catch(Exception e)
            {
        ...
        private static bool AgregarFrutas(SegundoParcial frm)
        {
            ...
            try
            {
                ...
                comando.CommandType = CommandType.Text;
                comando.Connection = conexion;
                comando.CommandText = "INSERT INTO [sp_lab_II].[dbo].[frutas] (nombre, peso, precio) values ('" + frm._manzana + "', '" + frm._banana + "', '" + frm._durazno + "')";
                conexion.Open();
                retorno = true;
